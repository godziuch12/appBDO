...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetCollectingTransferredVehiclesResponse :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetCollectingTransferredVehiclesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetCollectingTransferredVehiclesResponse" /> class.
        /// </summary>
        ...
        /// <param name="collectingTransferredVehicles">collectingTransferredVehicles.</param>
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetCollectingTransferredVehiclesResponse(int? year = default(int?), string wasteCode = default(string), double? vehiclesMassSummary = default(double?), int? vehiclesCountSummary = default(int?), string cardNumber = default(string), double? initialVehiclesMass = default(double?), int? initialVehiclesCount = default(int?), bool? wasteCodeExtended = default(bool?), string wasteCodeExtendedDescription = default(string), bool? hazardousWasteReclassification = default(bool?), string hazardousWasteReclassificationDescription = default(string), WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1PaginatedPageCollectingTransferredVehicleListItem collectingTransferredVehicles = default(WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1PaginatedPageCollectingTransferredVehicleListItem))
        {
            this.Year = year;
            ...
            this.CollectingTransferredVehicles = collectingTransferredVehicles;
        }
        ...
        /// <summary>
        /// Gets or Sets CollectingTransferredVehicles
        /// </summary>
        [DataMember(Name="collectingTransferredVehicles", EmitDefaultValue=false)]
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1PaginatedPageCollectingTransferredVehicleListItem CollectingTransferredVehicles { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetCollectingTransferredVehiclesResponse {\n");
            ...
            sb.Append("  CollectingTransferredVehicles: ").Append(CollectingTransferredVehicles).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetCollectingTransferredVehiclesResponse);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetCollectingTransferredVehiclesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetCollectingTransferredVehiclesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetCollectingTransferredVehiclesResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.CollectingTransferredVehicles == input.CollectingTransferredVehicles ||
                    (this.CollectingTransferredVehicles != null &&
                    this.CollectingTransferredVehicles.Equals(input.CollectingTransferredVehicles))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CollectingTransferredVehicles != null)
                    hashCode = hashCode * 59 + this.CollectingTransferredVehicles.GetHashCode();
                return hashCode;
            }
        }
