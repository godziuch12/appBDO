...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsCarrierRequest :  IEquatable<WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsCarrierRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsCarrierRequest" /> class.
        /// </summary>
        ...
        public WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsCarrierRequest(WasteRegisterPublicApiApiModelsCollectionsPaginationParameters paginationParameters = default(WasteRegisterPublicApiApiModelsCollectionsPaginationParameters), bool? searchInReceivers = default(bool?), bool? searchInSenders = default(bool?), string name = default(string), string locality = default(string), string street = default(string), string nip = default(string), string identificationNumber = default(string), string wasteCodeAndDescription = default(string), string cardNumber = default(string), string cardStatusCodeNames = default(string), DateTime? transportTime = default(DateTime?), DateTime? receiveConfirmationTime = default(DateTime?), string senderFirstNameAndLastName = default(string), string receiverFirstNameAndLastName = default(string), string vehicleRegNumber = default(string), bool? transportDateRange = default(bool?), DateTime? transportDateFrom = default(DateTime?), DateTime? transportDateTo = default(DateTime?), bool? receiveConfirmationDateRange = default(bool?), DateTime? receiveConfirmationDateFrom = default(DateTime?), DateTime? receiveConfirmationDateTo = default(DateTime?))
        {
        ...
        /// <summary>
        /// Flaga ustawiana na true, jeśli wyszukiwanie ma się odbyć w kontekście przejmującego
        /// </summary>
        /// <value>Flaga ustawiana na true, jeśli wyszukiwanie ma się odbyć w kontekście przejmującego</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsCarrierRequest {\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsCarrierRequest);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsCarrierRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsCarrierRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsCarrierRequest input)
        {
            if (input == null)
                return false;
