...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleInitialWasteEditableListItem :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleInitialWasteEditableListItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleInitialWasteEditableListItem" /> class.
        /// </summary>
        /// <param name="dismantleInitialWasteId">Id stanu magazynowego.</param>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleInitialWasteEditableListItem(Guid? dismantleInitialWasteId = default(Guid?), string wasteCode = default(string), int? wasteCodeId = default(int?), double? wasteMass = default(double?), bool? wasteCodeExtended = default(bool?), string wasteCodeExtendedDescription = default(string), bool? hazardousWasteReclassification = default(bool?), string hazardousWasteReclassificationDescription = default(string))
        {
            this.DismantleInitialWasteId = dismantleInitialWasteId;
        ...
        /// <summary>
        /// Id stanu magazynowego
        /// </summary>
        /// <value>Id stanu magazynowego</value>
        [DataMember(Name="dismantleInitialWasteId", EmitDefaultValue=false)]
        public Guid? DismantleInitialWasteId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleInitialWasteEditableListItem {\n");
            sb.Append("  DismantleInitialWasteId: ").Append(DismantleInitialWasteId).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleInitialWasteEditableListItem);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleInitialWasteEditableListItem instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleInitialWasteEditableListItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleInitialWasteEditableListItem input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.DismantleInitialWasteId == input.DismantleInitialWasteId ||
                    (this.DismantleInitialWasteId != null &&
                    this.DismantleInitialWasteId.Equals(input.DismantleInitialWasteId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.DismantleInitialWasteId != null)
                    hashCode = hashCode * 59 + this.DismantleInitialWasteId.GetHashCode();
