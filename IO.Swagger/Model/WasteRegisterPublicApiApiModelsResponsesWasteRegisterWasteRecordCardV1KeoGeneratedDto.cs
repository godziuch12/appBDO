...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteRecordCardV1KeoGeneratedDto :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteRecordCardV1KeoGeneratedDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteRecordCardV1KeoGeneratedDto" /> class.
        /// </summary>
        ...
        /// <param name="communeId">Pochodzenie odpadów - Id gminy.</param>
        /// <param name="manufactureDate">Data wytworzenia.</param>
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteRecordCardV1KeoGeneratedDto(Guid? keoGeneratedId = default(Guid?), Guid? keoId = default(Guid?), string installationName = default(string), double? wasteMassInstallation = default(double?), double? wasteMassExcludingInstallation = default(double?), bool? wasteFromServices = default(bool?), string communeId = default(string), DateTime? manufactureDate = default(DateTime?))
        {
        ...
        /// <summary>
        /// Pochodzenie odpadów - Id gminy
        /// </summary>
        /// <value>Pochodzenie odpadów - Id gminy</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteRecordCardV1KeoGeneratedDto {\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteRecordCardV1KeoGeneratedDto);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteRecordCardV1KeoGeneratedDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteRecordCardV1KeoGeneratedDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteRecordCardV1KeoGeneratedDto input)
        {
            if (input == null)
                return false;
