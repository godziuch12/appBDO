...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetDismantleWasteSummaryResponse :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetDismantleWasteSummaryResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetDismantleWasteSummaryResponse" /> class.
        /// </summary>
        ...
        /// <param name="dismantleWasteSummary">dismantleWasteSummary.</param>
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetDismantleWasteSummaryResponse(double? initialVehiclesMass = default(double?), int? initialVehiclesCount = default(int?), string wasteCode = default(string), string cardNumber = default(string), int? year = default(int?), bool? isDismantle = default(bool?), bool? wasteCodeExtended = default(bool?), string wasteCodeExtendedDescription = default(string), bool? hazardousWasteReclassification = default(bool?), string hazardousWasteReclassificationDescription = default(string), WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleWasteSummary dismantleWasteSummary = default(WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleWasteSummary))
        {
            ...
            this.DismantleWasteSummary = dismantleWasteSummary;
        }
        ...
        /// <summary>
        /// Gets or Sets DismantleWasteSummary
        /// </summary>
        [DataMember(Name="dismantleWasteSummary", EmitDefaultValue=false)]
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1DismantleWasteSummary DismantleWasteSummary { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetDismantleWasteSummaryResponse {\n");
            ...
            sb.Append("  DismantleWasteSummary: ").Append(DismantleWasteSummary).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetDismantleWasteSummaryResponse);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetDismantleWasteSummaryResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetDismantleWasteSummaryResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterWreckWasteRecordCardV1GetDismantleWasteSummaryResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DismantleWasteSummary == input.DismantleWasteSummary ||
                    (this.DismantleWasteSummary != null &&
                    this.DismantleWasteSummary.Equals(input.DismantleWasteSummary))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DismantleWasteSummary != null)
                    hashCode = hashCode * 59 + this.DismantleWasteSummary.GetHashCode();
                return hashCode;
            }
        }
