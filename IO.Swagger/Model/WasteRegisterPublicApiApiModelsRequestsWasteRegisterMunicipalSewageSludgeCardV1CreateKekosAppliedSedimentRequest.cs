...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1CreateKekosAppliedSedimentRequest :  IEquatable<WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1CreateKekosAppliedSedimentRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1CreateKekosAppliedSedimentRequest" /> class.
        /// </summary>
        ...
        public WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1CreateKekosAppliedSedimentRequest(Guid? kekosResearchCardId = default(Guid?), Guid? kekosId = default(Guid?), Guid? kpoId = default(Guid?), double? appliedSludgeMass = default(double?), double? appliedSludgeDryMatterMass = default(double?), DateTime? sludgeApplicationDate = default(DateTime?), string sludgeApplicationPlaceTerytPk = default(string), double? sludgeApplicationSurface = default(double?), Guid? kekosBatchOfGeneratedSedimentId = default(Guid?), bool? isApplicationPurposeCrops = default(bool?), bool? isApplicationPurposePlants = default(bool?), bool? isApplicationPurposeInediblePlants = default(bool?), bool? isApplicationPurposeReclamation = default(bool?), bool? isApplicationPurposeLandAdjustment = default(bool?), bool? isSoilGroupLight = default(bool?), bool? isSoilGroupMedium = default(bool?), bool? isSoilGroupHeavy = default(bool?), List<WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1NewKekosLandSurfaceRulerDto> landSurfaceRulers = default(List<WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1NewKekosLandSurfaceRulerDto>), List<WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1NewLotPrecinctDto> lotPrecincts = default(List<WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1NewLotPrecinctDto>))
        {
        ...
        public List<WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1NewKekosLandSurfaceRulerDto> LandSurfaceRulers { get; set; }
        ...
        public List<WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1NewLotPrecinctDto> LotPrecincts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1CreateKekosAppliedSedimentRequest {\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1CreateKekosAppliedSedimentRequest);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1CreateKekosAppliedSedimentRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1CreateKekosAppliedSedimentRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsRequestsWasteRegisterMunicipalSewageSludgeCardV1CreateKekosAppliedSedimentRequest input)
        {
            if (input == null)
                return false;
