...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1KpokAsReceiverSearchResultDto :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1KpokAsReceiverSearchResultDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1KpokAsReceiverSearchResultDto" /> class.
        /// </summary>
        ...
        /// <param name="rejectedByUserFirstNameAndLastName">Imię i Nazwisko osoby odrzucającej kartę.</param>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1KpokAsReceiverSearchResultDto(DateTime? plannedTransportTime = default(DateTime?), DateTime? realTransportTime = default(DateTime?), string wasteCode = default(string), string wasteCodeDescription = default(string), string vehicleRegNumber = default(string), string cardStatus = default(string), string cardNumber = default(string), string cardStatusCodeName = default(string), string cardSubtype = default(string), string senderName = default(string), string receiverName = default(string), Guid? kpokId = default(Guid?), DateTime? kpokLastModifiedAt = default(DateTime?), string senderFirstNameAndLastName = default(string), string receiverFirstAndLastName = default(string), int? revisionNumber = default(int?), DateTime? cardRejectionTime = default(DateTime?), string rejectedByUserFirstNameAndLastName = default(string), DateTime? receiveConfirmationTime = default(DateTime?), bool? wasteCodeExtended = default(bool?), string wasteCodeExtendedDescription = default(string), bool? hazardousWasteReclassification = default(bool?), string hazardousWasteReclassificationDescription = default(string))
        {
            ...
            this.RejectedByUserFirstNameAndLastName = rejectedByUserFirstNameAndLastName;
        ...
        /// <summary>
        /// Imię i Nazwisko osoby odrzucającej kartę
        /// </summary>
        /// <value>Imię i Nazwisko osoby odrzucającej kartę</value>
        [DataMember(Name="rejectedByUserFirstNameAndLastName", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1KpokAsReceiverSearchResultDto {\n");
            ...
            sb.Append("  RejectedByUserFirstNameAndLastName: ").Append(RejectedByUserFirstNameAndLastName).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1KpokAsReceiverSearchResultDto);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1KpokAsReceiverSearchResultDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1KpokAsReceiverSearchResultDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1KpokAsReceiverSearchResultDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RejectedByUserFirstNameAndLastName == input.RejectedByUserFirstNameAndLastName ||
                    (this.RejectedByUserFirstNameAndLastName != null &&
                    this.RejectedByUserFirstNameAndLastName.Equals(input.RejectedByUserFirstNameAndLastName))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RejectedByUserFirstNameAndLastName != null)
                    hashCode = hashCode * 59 + this.RejectedByUserFirstNameAndLastName.GetHashCode();
