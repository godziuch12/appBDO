...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1GetKekosAppliedSedimentResponse :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1GetKekosAppliedSedimentResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1GetKekosAppliedSedimentResponse" /> class.
        /// </summary>
        ...
        /// <param name="sludgeApplicationPlaceAddressHtml">sludgeApplicationPlaceAddressHtml.</param>
        /// <param name="sludgeApplicationSurface">Powierzchnia zastosowania komunalnych osadów ściekowych [ha].</param>
        /// <param name="recordingUserId">recordingUserId.</param>
        /// <param name="recordingUser">recordingUser.</param>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1GetKekosAppliedSedimentResponse(Guid? kekosAppliedSedimentId = default(Guid?), Guid? kekosResearchCardId = default(Guid?), string researchNumber = default(string), Guid? kekosId = default(Guid?), Guid? kpoId = default(Guid?), string kpoCardNumber = default(string), double? appliedSludgeMass = default(double?), double? appliedSludgeDryMatterMass = default(double?), DateTime? sludgeApplicationDate = default(DateTime?), string sludgeApplicationPlaceTerytPk = default(string), string sludgeApplicationPlaceAddressHtml = default(string), double? sludgeApplicationSurface = default(double?), Guid? recordingUserId = default(Guid?), string recordingUser = default(string), Guid? kekosBatchOfGeneratedSedimentId = default(Guid?), string batchNumber = default(string), DateTime? createdAt = default(DateTime?), bool? isApplicationPurposeCrops = default(bool?), bool? isApplicationPurposePlants = default(bool?), bool? isApplicationPurposeInediblePlants = default(bool?), bool? isApplicationPurposeReclamation = default(bool?), bool? isApplicationPurposeLandAdjustment = default(bool?), bool? isSoilGroupLight = default(bool?), bool? isSoilGroupMedium = default(bool?), bool? isSoilGroupHeavy = default(bool?), List<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1LotPrecinctDto> lotPrecincts = default(List<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1LotPrecinctDto>), List<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1LandSurfaceRulerDto> landSurfaceRulers = default(List<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1LandSurfaceRulerDto>))
        {
            ...
            this.SludgeApplicationPlaceAddressHtml = sludgeApplicationPlaceAddressHtml;
        ...
        /// <summary>
        /// Gets or Sets SludgeApplicationPlaceAddressHtml
        /// </summary>
        [DataMember(Name="sludgeApplicationPlaceAddressHtml", EmitDefaultValue=false)]
        public string SludgeApplicationPlaceAddressHtml { get; set; }
        ...
        /// <summary>
        /// Gets or Sets RecordingUserId
        /// </summary>
        [DataMember(Name="recordingUserId", EmitDefaultValue=false)]
        public Guid? RecordingUserId { get; set; }

        /// <summary>
        /// Gets or Sets RecordingUser
        /// </summary>
        [DataMember(Name="recordingUser", EmitDefaultValue=false)]
        ...
        public List<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1LotPrecinctDto> LotPrecincts { get; set; }
        ...
        public List<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1LandSurfaceRulerDto> LandSurfaceRulers { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1GetKekosAppliedSedimentResponse {\n");
            ...
            sb.Append("  SludgeApplicationPlaceAddressHtml: ").Append(SludgeApplicationPlaceAddressHtml).Append("\n");
            sb.Append("  SludgeApplicationSurface: ").Append(SludgeApplicationSurface).Append("\n");
            sb.Append("  RecordingUserId: ").Append(RecordingUserId).Append("\n");
            sb.Append("  RecordingUser: ").Append(RecordingUser).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1GetKekosAppliedSedimentResponse);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1GetKekosAppliedSedimentResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1GetKekosAppliedSedimentResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterMunicipalSewageSludgeCardV1GetKekosAppliedSedimentResponse input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SludgeApplicationPlaceAddressHtml == input.SludgeApplicationPlaceAddressHtml ||
                    (this.SludgeApplicationPlaceAddressHtml != null &&
                    this.SludgeApplicationPlaceAddressHtml.Equals(input.SludgeApplicationPlaceAddressHtml))
                ) && 
                (
                ...
                (
                    this.RecordingUserId == input.RecordingUserId ||
                    (this.RecordingUserId != null &&
                    this.RecordingUserId.Equals(input.RecordingUserId))
                ) && 
                (
                    this.RecordingUser == input.RecordingUser ||
                    (this.RecordingUser != null &&
                    this.RecordingUser.Equals(input.RecordingUser))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SludgeApplicationPlaceAddressHtml != null)
                    hashCode = hashCode * 59 + this.SludgeApplicationPlaceAddressHtml.GetHashCode();
                if (this.SludgeApplicationSurface != null)
                    hashCode = hashCode * 59 + this.SludgeApplicationSurface.GetHashCode();
                if (this.RecordingUserId != null)
                    hashCode = hashCode * 59 + this.RecordingUserId.GetHashCode();
                if (this.RecordingUser != null)
                    hashCode = hashCode * 59 + this.RecordingUser.GetHashCode();
