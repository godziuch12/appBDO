...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoPrintingPage :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoPrintingPage>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoPrintingPage" /> class.
        /// </summary>
        ...
        /// <param name="senderIdentificationNumber">Numer identyfikacyjny podmiotu przekazującego odpady.</param>
        ...
        /// <param name="wasteProcessWithCode">wasteProcessWithCode.</param>
        /// <param name="remarks">Uwagi.</param>
        /// <param name="vehicleRegNumber">Numer rejestracyjny środka transportu.</param>
        /// <param name="realTransportDate">Rzeczywista data transportu.</param>
        /// <param name="realTransportTime">Rzeczywista godzina transportu.</param>
        /// <param name="receiveConfirmationDate">Data otrzymania potwierdzenia.</param>
        /// <param name="receiveConfirmationTime">Godzina otrzymania potwierdzenia.</param>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoPrintingPage(string cardNumber = default(string), string cardStatus = default(string), int? calendarYear = default(int?), string senderNameOrFirstNameAndLastName = default(string), string senderAddress = default(string), string senderEupNumber = default(string), string senderEupName = default(string), string senderEupAddress = default(string), string senderIdentificationNumber = default(string), string senderNip = default(string), string senderNipEu = default(string), string carrierNameOrFirstNameAndLastName = default(string), string carrierAddress = default(string), string carrierIdentificationNumber = default(string), string carrierNip = default(string), string carrierNipEu = default(string), string receiverNameOrFirstNameAndLastName = default(string), string receiverAddress = default(string), string receiverEupNumber = default(string), string receiverEupName = default(string), string receiverEupAddress = default(string), string receiverIdentificationNumber = default(string), string receiverNip = default(string), string receiverNipEu = default(string), string wasteCodeAndDescription = default(string), string wasteMass = default(string), string certificateNumber = default(string), string wasteProcess = default(string), string wasteProcessWithCode = default(string), string remarks = default(string), string vehicleRegNumber = default(string), string realTransportDate = default(string), string realTransportTime = default(string), string receiveConfirmationDate = default(string), string receiveConfirmationTime = default(string), string approvalDate = default(string), string approvalTime = default(string), string approvedByUser = default(string), string transportConfirmationDate = default(string), string transportConfirmationTime = default(string), string transportConfirmedByUser = default(string), string receiveConfirmedByUser = default(string), bool? wasteCodeExtended = default(bool?), string wasteCodeExtendedDescription = default(string), bool? hazardousWasteReclassification = default(bool?), string hazardousWasteReclassificationDescription = default(string))
        {
            ...
            this.WasteProcessWithCode = wasteProcessWithCode;
        ...
        /// <summary>
        /// Numer identyfikacyjny podmiotu przekazującego odpady
        /// </summary>
        /// <value>Numer identyfikacyjny podmiotu przekazującego odpady</value>
        ...
        /// <summary>
        /// Gets or Sets WasteProcessWithCode
        /// </summary>
        [DataMember(Name="wasteProcessWithCode", EmitDefaultValue=false)]
        public string WasteProcessWithCode { get; set; }
        ...
        /// <summary>
        /// Rzeczywista data transportu
        /// </summary>
        /// <value>Rzeczywista data transportu</value>
        [DataMember(Name="realTransportDate", EmitDefaultValue=false)]
        public string RealTransportDate { get; set; }

        /// <summary>
        /// Rzeczywista godzina transportu
        /// </summary>
        /// <value>Rzeczywista godzina transportu</value>
        ...
        /// <summary>
        /// Godzina otrzymania potwierdzenia
        /// </summary>
        /// <value>Godzina otrzymania potwierdzenia</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoPrintingPage {\n");
            ...
            sb.Append("  WasteProcessWithCode: ").Append(WasteProcessWithCode).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoPrintingPage);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoPrintingPage instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoPrintingPage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoPrintingPage input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WasteProcessWithCode == input.WasteProcessWithCode ||
                    (this.WasteProcessWithCode != null &&
                    this.WasteProcessWithCode.Equals(input.WasteProcessWithCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WasteProcessWithCode != null)
                    hashCode = hashCode * 59 + this.WasteProcessWithCode.GetHashCode();
