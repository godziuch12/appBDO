...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsRequestsWasteRegisterWreckWasteRecordCardDismantleReceivedVehicleV1UpdateDismantleReceivedVehicleRequest :  IEquatable<WasteRegisterPublicApiApiModelsRequestsWasteRegisterWreckWasteRecordCardDismantleReceivedVehicleV1UpdateDismantleReceivedVehicleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsRequestsWasteRegisterWreckWasteRecordCardDismantleReceivedVehicleV1UpdateDismantleReceivedVehicleRequest" /> class.
        /// </summary>
        /// <param name="kepwDismantleReceivedVehicleId">Id wpisu KEPW - Prowadzący stację demontażu Przyjęte pojazdy.</param>
        ...
        public WasteRegisterPublicApiApiModelsRequestsWasteRegisterWreckWasteRecordCardDismantleReceivedVehicleV1UpdateDismantleReceivedVehicleRequest(Guid? kepwDismantleReceivedVehicleId = default(Guid?), bool? receivedFromDismantleStation = default(bool?), DateTime? receiveDate = default(DateTime?), double? vehiclesMass = default(double?), int? vehiclesCount = default(int?), Guid? kpoId = default(Guid?), bool? receivedWithKpo = default(bool?), bool? receivedFromAbroad = default(bool?), bool? ownerNotRegistered = default(bool?), int? countryId = default(int?), string locality = default(string), string street = default(string), string buildingNumber = default(string), string localNumber = default(string), string postalCode = default(string), string additionalInfo = default(string))
        {
            this.KepwDismantleReceivedVehicleId = kepwDismantleReceivedVehicleId;
        ...
        /// <summary>
        /// Id wpisu KEPW - Prowadzący stację demontażu Przyjęte pojazdy
        /// </summary>
        /// <value>Id wpisu KEPW - Prowadzący stację demontażu Przyjęte pojazdy</value>
        [DataMember(Name="kepwDismantleReceivedVehicleId", EmitDefaultValue=false)]
        public Guid? KepwDismantleReceivedVehicleId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsRequestsWasteRegisterWreckWasteRecordCardDismantleReceivedVehicleV1UpdateDismantleReceivedVehicleRequest {\n");
            sb.Append("  KepwDismantleReceivedVehicleId: ").Append(KepwDismantleReceivedVehicleId).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsRequestsWasteRegisterWreckWasteRecordCardDismantleReceivedVehicleV1UpdateDismantleReceivedVehicleRequest);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsRequestsWasteRegisterWreckWasteRecordCardDismantleReceivedVehicleV1UpdateDismantleReceivedVehicleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsRequestsWasteRegisterWreckWasteRecordCardDismantleReceivedVehicleV1UpdateDismantleReceivedVehicleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsRequestsWasteRegisterWreckWasteRecordCardDismantleReceivedVehicleV1UpdateDismantleReceivedVehicleRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.KepwDismantleReceivedVehicleId == input.KepwDismantleReceivedVehicleId ||
                    (this.KepwDismantleReceivedVehicleId != null &&
                    this.KepwDismantleReceivedVehicleId.Equals(input.KepwDismantleReceivedVehicleId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.KepwDismantleReceivedVehicleId != null)
                    hashCode = hashCode * 59 + this.KepwDismantleReceivedVehicleId.GetHashCode();
