...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentManagementDto :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentManagementDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentManagementDto" /> class.
        /// </summary>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentManagementDto(Guid? kezsEquipmentManagementId = default(Guid?), Guid? kezsEquipmentGroupCardId = default(Guid?), Guid? createdByUserId = default(Guid?), DateTime? createdAt = default(DateTime?), bool? isHandedOver = default(bool?), bool? isUsed = default(bool?), bool? isRecycled = default(bool?), Guid? kpoId = default(Guid?), Guid? kpokId = default(Guid?), bool? isEntryBasedOnKpo = default(bool?), bool? isEntryBasedOnKpok = default(bool?), DateTime? kpoHandoverDate = default(DateTime?), double? handedOverEquipmentMass = default(double?), double? recycledEquipmentMass = default(double?), double? usedEquipmentMass = default(double?), string additionalInformation = default(string), string installationName = default(string), string createdByUser = default(string), string kpoCardNumber = default(string), string kpokCardNumber = default(string), int? wasteProcessId = default(int?), bool? isRecycling = default(bool?), bool? isRecycledParts = default(bool?), double? recycledPartsEquipmentMass = default(double?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentManagementDto {\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentManagementDto);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentManagementDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentManagementDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentManagementDto input)
        {
            if (input == null)
                return false;
