...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1ApprovedKpoDto :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1ApprovedKpoDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1ApprovedKpoDto" /> class.
        /// </summary>
        ...
        /// <param name="cardApprovalTime">Data i godzina zatwierdzenia Karty Przekazania Odpadów.</param>
        /// <param name="realTransportTime">Rzeczywista data i godzina transportu.</param>
        /// <param name="approvalUser">Użytkownik zatwierdzający Kartę Przekazania Odpadów.</param>
        ...
        /// <param name="wasteCodeExtended">Flaga ustawiana na true, jeśli kod odpadu ma status extended.</param>
        /// <param name="wasteCodeExtendedDescription">Rodzaj odpadu extended.</param>
        /// <param name="hazardousWasteReclassification">Flaga ustawiana na true, jeśli zmiana statusu odpadów niebezpiecznych na inne niż niebezpieczne.</param>
        /// <param name="hazardousWasteReclassificationDescription">Rodzaj odpadu po zmianie statusu odpadów niebezpiecznych na inne niż niebezpieczne.</param>
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1ApprovedKpoDto(Guid? kpoId = default(Guid?), int? year = default(int?), string cardNumber = default(string), int? cardStatusId = default(int?), string cardStatus = default(string), Guid? senderCompanyId = default(Guid?), Guid? senderEupId = default(Guid?), Guid? carrierCompanyId = default(Guid?), Guid? receiverCompanyId = default(Guid?), Guid? receiverEupId = default(Guid?), int? wasteCodeId = default(int?), string vehicleRegNumber = default(string), double? wasteMass = default(double?), DateTime? plannedTransportTime = default(DateTime?), DateTime? cardApprovalTime = default(DateTime?), DateTime? realTransportTime = default(DateTime?), string approvalUser = default(string), int? wasteProcessId = default(int?), string certificateNumberAndBoxNumbers = default(string), string cardStatusCodeName = default(string), string additionalInfo = default(string), bool? wasteCodeExtended = default(bool?), string wasteCodeExtendedDescription = default(string), bool? hazardousWasteReclassification = default(bool?), string hazardousWasteReclassificationDescription = default(string))
        {
            this.KpoId = kpoId;
            this.Year = year;
        ...
        /// </summary>
        /// <value>Data i godzina zatwierdzenia Karty Przekazania Odpadów</value>
        ...
        /// </summary>
        /// <value>Użytkownik zatwierdzający Kartę Przekazania Odpadów</value>
        ...
        /// </summary>
        /// <value>Flaga ustawiana na true, jeśli kod odpadu ma status extended</value>
        ...
        /// </summary>
        /// <value>Rodzaj odpadu extended</value>
        ...
        /// </summary>
        /// <value>Flaga ustawiana na true, jeśli zmiana statusu odpadów niebezpiecznych na inne niż niebezpieczne</value>
        ...
        /// </summary>
        /// <value>Rodzaj odpadu po zmianie statusu odpadów niebezpiecznych na inne niż niebezpieczne</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1ApprovedKpoDto {\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1ApprovedKpoDto);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1ApprovedKpoDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1ApprovedKpoDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1ApprovedKpoDto input)
        {
            if (input == null)
                return false;
