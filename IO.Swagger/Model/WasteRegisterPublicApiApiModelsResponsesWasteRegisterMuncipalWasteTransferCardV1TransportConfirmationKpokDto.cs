...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1TransportConfirmationKpokDto :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1TransportConfirmationKpokDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1TransportConfirmationKpokDto" /> class.
        /// </summary>
        ...
        /// <param name="receiveConfirmationUser">Użytkownik generujący potwierdzenie.</param>
        ...
        /// <param name="transportConfirmationUser">Użytkownik potwierdzający transport.</param>
        /// <param name="transportConfirmationTime">Data potwierdzenia transportu.</param>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1TransportConfirmationKpokDto(Guid? kpokId = default(Guid?), string cardNumber = default(string), int? year = default(int?), int? cardStatusId = default(int?), string cardStatus = default(string), Guid? senderCompanyId = default(Guid?), Guid? senderEupId = default(Guid?), Guid? carrierCompanyId = default(Guid?), Guid? receiverCompanyId = default(Guid?), Guid? receiverEupId = default(Guid?), string communeId = default(string), string communeArea = default(string), int? wasteCodeId = default(int?), string vehicleRegNumber = default(string), double? wasteMass = default(double?), string cardSubtype = default(string), double? correctedWasteMass = default(double?), string remarks = default(string), DateTime? plannedTransportTime = default(DateTime?), DateTime? realTransportTime = default(DateTime?), string approvalUser = default(string), DateTime? cardApprovalTime = default(DateTime?), string generatingConfirmationUser = default(string), DateTime? generatingConfirmationTime = default(DateTime?), string receiveConfirmationUser = default(string), DateTime? receiveConfirmationTime = default(DateTime?), string cardStatusCodeName = default(string), string transportConfirmationUser = default(string), DateTime? transportConfirmationTime = default(DateTime?), DateTime? receiptEndingTime = default(DateTime?), bool? isRevised = default(bool?), DateTime? revisedAt = default(DateTime?), string revisedBy = default(string), double? revisedWasteMass = default(double?), int? revisedWasteCodeId = default(int?), string additionalInfo = default(string), bool? wasteCodeExtended = default(bool?), string wasteCodeExtendedDescription = default(string), bool? hazardousWasteReclassification = default(bool?), string hazardousWasteReclassificationDescription = default(string))
        {
            this.KpokId = kpokId;
            ...
            this.ReceiveConfirmationUser = receiveConfirmationUser;
            this.ReceiveConfirmationTime = receiveConfirmationTime;
            this.CardStatusCodeName = cardStatusCodeName;
            this.TransportConfirmationUser = transportConfirmationUser;
        ...
        /// </summary>
        /// <value>Użytkownik generujący potwierdzenie</value>
        [DataMember(Name="receiveConfirmationUser", EmitDefaultValue=false)]
        ...
        [DataMember(Name="transportConfirmationUser", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1TransportConfirmationKpokDto {\n");
            ...
            sb.Append("  ReceiveConfirmationUser: ").Append(ReceiveConfirmationUser).Append("\n");
            ...
            sb.Append("  TransportConfirmationUser: ").Append(TransportConfirmationUser).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1TransportConfirmationKpokDto);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1TransportConfirmationKpokDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1TransportConfirmationKpokDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1TransportConfirmationKpokDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.ReceiveConfirmationUser == input.ReceiveConfirmationUser ||
                    (this.ReceiveConfirmationUser != null &&
                    this.ReceiveConfirmationUser.Equals(input.ReceiveConfirmationUser))
                ) && 
                (
                ...
                (
                    this.TransportConfirmationUser == input.TransportConfirmationUser ||
                    (this.TransportConfirmationUser != null &&
                    this.TransportConfirmationUser.Equals(input.TransportConfirmationUser))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ReceiveConfirmationUser != null)
                    hashCode = hashCode * 59 + this.ReceiveConfirmationUser.GetHashCode();
                ...
                if (this.TransportConfirmationUser != null)
                    hashCode = hashCode * 59 + this.TransportConfirmationUser.GetHashCode();
