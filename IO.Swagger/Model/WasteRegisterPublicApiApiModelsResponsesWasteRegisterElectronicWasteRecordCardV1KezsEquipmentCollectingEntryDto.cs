...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentCollectingEntryDto :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentCollectingEntryDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentCollectingEntryDto" /> class.
        /// </summary>
        /// <param name="kezsEquipmentCollectingEntryId">Id wpisu Zbieranie sprzętu.</param>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentCollectingEntryDto(Guid? kezsEquipmentCollectingEntryId = default(Guid?), Guid? kezsEquipmentGroupCardId = default(Guid?), Guid? kpoId = default(Guid?), Guid? kpokId = default(Guid?), bool? receivedFromUser = default(bool?), bool? isEquipmentOwnerExemptFromRecord = default(bool?), bool? isImportToRp = default(bool?), bool? isEntryBasedOnKpo = default(bool?), bool? isEntryBasedOnKpok = default(bool?), DateTime? receivedDate = default(DateTime?), double? receivedEquipmentMass = default(double?), int? countryId = default(int?), string locality = default(string), string street = default(string), string postalCode = default(string), string buildingNumber = default(string), string localNumber = default(string), string additionalInformation = default(string), string country = default(string), string createdByUser = default(string), string kpoCardNumber = default(string), string kpokCardNumber = default(string))
        {
            this.KezsEquipmentCollectingEntryId = kezsEquipmentCollectingEntryId;
        ...
        /// <summary>
        /// Id wpisu Zbieranie sprzętu
        /// </summary>
        /// <value>Id wpisu Zbieranie sprzętu</value>
        [DataMember(Name="kezsEquipmentCollectingEntryId", EmitDefaultValue=false)]
        public Guid? KezsEquipmentCollectingEntryId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentCollectingEntryDto {\n");
            sb.Append("  KezsEquipmentCollectingEntryId: ").Append(KezsEquipmentCollectingEntryId).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentCollectingEntryDto);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentCollectingEntryDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentCollectingEntryDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsEquipmentCollectingEntryDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.KezsEquipmentCollectingEntryId == input.KezsEquipmentCollectingEntryId ||
                    (this.KezsEquipmentCollectingEntryId != null &&
                    this.KezsEquipmentCollectingEntryId.Equals(input.KezsEquipmentCollectingEntryId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.KezsEquipmentCollectingEntryId != null)
                    hashCode = hashCode * 59 + this.KezsEquipmentCollectingEntryId.GetHashCode();
