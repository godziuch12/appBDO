...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoAsCarrierSearchResultDto :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoAsCarrierSearchResultDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoAsCarrierSearchResultDto" /> class.
        /// </summary>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoAsCarrierSearchResultDto(DateTime? plannedTransportTime = default(DateTime?), DateTime? realTransportTime = default(DateTime?), string wasteCode = default(string), string wasteCodeDescription = default(string), string vehicleRegNumber = default(string), string cardStatus = default(string), string cardNumber = default(string), string cardStatusCodeName = default(string), string senderName = default(string), string receiverName = default(string), Guid? kpoId = default(Guid?), DateTime? kpoLastModifiedAt = default(DateTime?), string senderFirstNameAndLastName = default(string), string receiverFirstAndLastName = default(string), int? revisionNumber = default(int?), DateTime? cardRejectionTime = default(DateTime?), bool? wasteCodeExtended = default(bool?), bool? hazardousWasteReclassification = default(bool?), string wasteCodeExtendedDescription = default(string), string hazardousWasteReclassificationDescription = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoAsCarrierSearchResultDto {\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoAsCarrierSearchResultDto);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoAsCarrierSearchResultDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoAsCarrierSearchResultDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterWasteTransferCardV1KpoAsCarrierSearchResultDto input)
        {
            if (input == null)
                return false;
