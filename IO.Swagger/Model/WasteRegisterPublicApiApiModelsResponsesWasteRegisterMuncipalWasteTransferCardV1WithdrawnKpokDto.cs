...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1WithdrawnKpokDto :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1WithdrawnKpokDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1WithdrawnKpokDto" /> class.
        /// </summary>
        ...
        /// <param name="withdrawnByUser">withdrawnByUser.</param>
        /// <param name="cardWithdrawalTime">Data wycofania karty.</param>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1WithdrawnKpokDto(Guid? kpokId = default(Guid?), int? year = default(int?), int? cardStatusId = default(int?), string cardStatus = default(string), string previousStatusCodeName = default(string), Guid? senderCompanyId = default(Guid?), Guid? senderEupId = default(Guid?), Guid? carrierCompanyId = default(Guid?), Guid? receiverCompanyId = default(Guid?), Guid? receiverEupId = default(Guid?), string communeId = default(string), string communeArea = default(string), string remarks = default(string), int? wasteCodeId = default(int?), string vehicleRegNumber = default(string), double? wasteMass = default(double?), DateTime? plannedTransportTime = default(DateTime?), string cardSubtype = default(string), DateTime? realTransportTime = default(DateTime?), string approvalUser = default(string), DateTime? cardApprovalTime = default(DateTime?), string withdrawnByUser = default(string), DateTime? cardWithdrawalTime = default(DateTime?), string generatingConfirmationUser = default(string), DateTime? generatingConfirmationTime = default(DateTime?), string cardStatusCodeName = default(string), string cardNumber = default(string), bool? wasteCodeExtended = default(bool?), string wasteCodeExtendedDescription = default(string), bool? hazardousWasteReclassification = default(bool?), string additionalInfo = default(string), string hazardousWasteReclassificationDescription = default(string))
        {
            this.KpokId = kpokId;
            this.Year = year;
        ...
        /// </summary>
        [DataMember(Name="withdrawnByUser", EmitDefaultValue=false)]
        public string WithdrawnByUser { get; set; }

        /// <summary>
        /// Data wycofania karty
        /// </summary>
        /// <value>Data wycofania karty</value>
        [DataMember(Name="cardWithdrawalTime", EmitDefaultValue=false)]
        public DateTime? CardWithdrawalTime { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1WithdrawnKpokDto {\n");
            ...
            sb.Append("  WithdrawnByUser: ").Append(WithdrawnByUser).Append("\n");
            sb.Append("  CardWithdrawalTime: ").Append(CardWithdrawalTime).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1WithdrawnKpokDto);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1WithdrawnKpokDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1WithdrawnKpokDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterMuncipalWasteTransferCardV1WithdrawnKpokDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.WithdrawnByUser == input.WithdrawnByUser ||
                    (this.WithdrawnByUser != null &&
                    this.WithdrawnByUser.Equals(input.WithdrawnByUser))
                ) && 
                (
                    this.CardWithdrawalTime == input.CardWithdrawalTime ||
                    (this.CardWithdrawalTime != null &&
                    this.CardWithdrawalTime.Equals(input.CardWithdrawalTime))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WithdrawnByUser != null)
                    hashCode = hashCode * 59 + this.WithdrawnByUser.GetHashCode();
                if (this.CardWithdrawalTime != null)
                    hashCode = hashCode * 59 + this.CardWithdrawalTime.GetHashCode();
