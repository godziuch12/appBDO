...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsWasteManagementHandedOverDto :  IEquatable<WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsWasteManagementHandedOverDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsWasteManagementHandedOverDto" /> class.
        /// </summary>
        /// <param name="kezsWasteManagementHandedOverId">Id wpisu Gospodarowanie sprzętem - przekazane do innego zakładu przetwarzania.</param>
        ...
        /// <param name="isRoad">isRoad.</param>
        /// <param name="isRailroad">isRailroad.</param>
        /// <param name="isSea">isSea.</param>
        /// <param name="isAir">isAir.</param>
        /// <param name="isWaterLand">isWaterLand.</param>
        ...
        public WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsWasteManagementHandedOverDto(Guid? kezsWasteManagementHandedOverId = default(Guid?), Guid? kezsEquipmentGroupCardId = default(Guid?), int? wasteCodeId = default(int?), Guid? kpoId = default(Guid?), Guid? kpokId = default(Guid?), Guid? createdByUserId = default(Guid?), DateTime? kpoHandoverDate = default(DateTime?), DateTime? createdAt = default(DateTime?), int? wasteProcessId = default(int?), double? wasteMass = default(double?), int? countryId = default(int?), string locality = default(string), string street = default(string), string postalCode = default(string), string buildingNumber = default(string), string localNumber = default(string), DateTime? wasteTransportStartDate = default(DateTime?), bool? isRoad = default(bool?), bool? isRailroad = default(bool?), bool? isSea = default(bool?), bool? isAir = default(bool?), bool? isWaterLand = default(bool?), bool? isSalvageWasteProcess = default(bool?), bool? isRecycling = default(bool?), bool? isEntryBasedOnKpo = default(bool?), bool? isEntryBasedOnKpok = default(bool?), bool? isExportFromRp = default(bool?), bool? isEquipmentOwnerExemptFromRecord = default(bool?), bool? isHandedOver = default(bool?), string additionalInformation = default(string), int? transportType = default(int?), string country = default(string), string createdByUser = default(string), string kpoCardNumber = default(string), string kpokCardNumber = default(string), bool? wasteCodeExtended = default(bool?), string wasteCodeExtendedDescription = default(string), bool? hazardousWasteReclassification = default(bool?), string hazardousWasteReclassificationDescription = default(string))
        {
            this.KezsWasteManagementHandedOverId = kezsWasteManagementHandedOverId;
        ...
        /// <summary>
        /// Id wpisu Gospodarowanie sprzętem - przekazane do innego zakładu przetwarzania
        /// </summary>
        /// <value>Id wpisu Gospodarowanie sprzętem - przekazane do innego zakładu przetwarzania</value>
        [DataMember(Name="kezsWasteManagementHandedOverId", EmitDefaultValue=false)]
        public Guid? KezsWasteManagementHandedOverId { get; set; }
        ...
        /// Gets or Sets IsRoad
        /// </summary>
        [DataMember(Name="isRoad", EmitDefaultValue=false)]
        public bool? IsRoad { get; set; }

        /// <summary>
        /// Gets or Sets IsRailroad
        /// </summary>
        [DataMember(Name="isRailroad", EmitDefaultValue=false)]
        public bool? IsRailroad { get; set; }

        /// <summary>
        /// Gets or Sets IsSea
        /// </summary>
        [DataMember(Name="isSea", EmitDefaultValue=false)]
        public bool? IsSea { get; set; }

        /// <summary>
        /// Gets or Sets IsAir
        /// </summary>
        [DataMember(Name="isAir", EmitDefaultValue=false)]
        public bool? IsAir { get; set; }

        /// <summary>
        /// Gets or Sets IsWaterLand
        /// </summary>
        [DataMember(Name="isWaterLand", EmitDefaultValue=false)]
        public bool? IsWaterLand { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsWasteManagementHandedOverDto {\n");
            sb.Append("  KezsWasteManagementHandedOverId: ").Append(KezsWasteManagementHandedOverId).Append("\n");
            ...
            sb.Append("  IsRoad: ").Append(IsRoad).Append("\n");
            sb.Append("  IsRailroad: ").Append(IsRailroad).Append("\n");
            sb.Append("  IsSea: ").Append(IsSea).Append("\n");
            sb.Append("  IsAir: ").Append(IsAir).Append("\n");
            sb.Append("  IsWaterLand: ").Append(IsWaterLand).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsWasteManagementHandedOverDto);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsWasteManagementHandedOverDto instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsWasteManagementHandedOverDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsResponsesWasteRegisterElectronicWasteRecordCardV1KezsWasteManagementHandedOverDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.KezsWasteManagementHandedOverId == input.KezsWasteManagementHandedOverId ||
                    (this.KezsWasteManagementHandedOverId != null &&
                    this.KezsWasteManagementHandedOverId.Equals(input.KezsWasteManagementHandedOverId))
                ) && 
                (
                ...
                (
                    this.IsRoad == input.IsRoad ||
                    (this.IsRoad != null &&
                    this.IsRoad.Equals(input.IsRoad))
                ) && 
                (
                    this.IsRailroad == input.IsRailroad ||
                    (this.IsRailroad != null &&
                    this.IsRailroad.Equals(input.IsRailroad))
                ) && 
                (
                    this.IsSea == input.IsSea ||
                    (this.IsSea != null &&
                    this.IsSea.Equals(input.IsSea))
                ) && 
                (
                    this.IsAir == input.IsAir ||
                    (this.IsAir != null &&
                    this.IsAir.Equals(input.IsAir))
                ) && 
                (
                    this.IsWaterLand == input.IsWaterLand ||
                    (this.IsWaterLand != null &&
                    this.IsWaterLand.Equals(input.IsWaterLand))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.KezsWasteManagementHandedOverId != null)
                    hashCode = hashCode * 59 + this.KezsWasteManagementHandedOverId.GetHashCode();
                ...
                if (this.IsRoad != null)
                    hashCode = hashCode * 59 + this.IsRoad.GetHashCode();
                if (this.IsRailroad != null)
                    hashCode = hashCode * 59 + this.IsRailroad.GetHashCode();
                if (this.IsSea != null)
                    hashCode = hashCode * 59 + this.IsSea.GetHashCode();
                if (this.IsAir != null)
                    hashCode = hashCode * 59 + this.IsAir.GetHashCode();
                if (this.IsWaterLand != null)
                    hashCode = hashCode * 59 + this.IsWaterLand.GetHashCode();
