...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsReceiverRequest :  IEquatable<WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsReceiverRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsReceiverRequest" /> class.
        /// </summary>
        ...
        /// <param name="searchInSenders">Flaga ustawiana na true, jeśli wyszukiwanie ma się odbyć w kontekście przekazującego.</param>
        ...
        /// <summary>
        /// Flaga ustawiana na true, jeśli wyszukiwanie ma się odbyć w kontekście transportującego
        /// </summary>
        /// <value>Flaga ustawiana na true, jeśli wyszukiwanie ma się odbyć w kontekście transportującego</value>
        [DataMember(Name="searchInCarriers", EmitDefaultValue=false)]
        public bool? SearchInCarriers { get; set; }

        /// <summary>
        /// Flaga ustawiana na true, jeśli wyszukiwanie ma się odbyć w kontekście przekazującego
        /// </summary>
        /// <value>Flaga ustawiana na true, jeśli wyszukiwanie ma się odbyć w kontekście przekazującego</value>
        ...
        /// </summary>
        /// <value>Numer identyfikacyjny podmiotu</value>
        ...
        /// </summary>
        /// <value>Imię i nazwisko wystawiającego</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsReceiverRequest {\n");
            sb.Append("  PaginationParameters: ").Append(PaginationParameters).Append("\n");
            sb.Append("  SearchInCarriers: ").Append(SearchInCarriers).Append("\n");
        ...
        {
            return this.Equals(input as WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsReceiverRequest);
        }

        /// <summary>
        /// Returns true if WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsReceiverRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsReceiverRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WasteRegisterPublicApiApiModelsRequestsWasteRegisterWasteTransferCardSearchCardsV1SearchKpoAsReceiverRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SearchInCarriers == input.SearchInCarriers ||
                    (this.SearchInCarriers != null &&
                    this.SearchInCarriers.Equals(input.SearchInCarriers))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SearchInCarriers != null)
                    hashCode = hashCode * 59 + this.SearchInCarriers.GetHashCode();
